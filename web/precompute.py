"""
precompute.py — Encode korpus web per (model, bahasa) -> embeddings cache (Makna/semantic).
...
Usage : python web/precompute.py                                  # semua model x bahasa
        python web/precompute.py --model intfloat/multilingual-e5-base --lang id
"""
