"""
5-embed.py — Encode korpus web per (model, bahasa) -> embeddings cache (Makna/semantic).
...
Usage : python src/code/4-training/5-embed.py                                  # semua model x bahasa
        python src/code/4-training/5-embed.py --model intfloat/multilingual-e5-base --lang id
"""
...
def _models(arg_model):
    if arg_model:
        return [(arg_model, Path(arg_model).name)]
