"""
5-simulasi-lanjutan.py — Mengevaluasi chunk raksasa dan membuat rule pemotongan.

Berdasarkan laporan dari 4-simulasi-chunk.py, script ini menginspeksi file-file 
...
def main():
    out_txt = config.EKSPLOR_DIR / "5-simulasi-lanjutan.txt"
